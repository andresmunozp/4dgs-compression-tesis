python scripts/extractimages.py multipleview/coffee_martini
...
mkdir ./data/multipleview/coffee_martini/sparse_
cp -r ./colmap_tmp/sparse/0/* ./data/multipleview/coffee_martini/sparse_
...
python scripts/downsample_point.py ./colmap_tmp/dense/fused.ply ./data/multipleview/coffee_martini/points3D_multipleview.ply

git clone https://github.com/Fyusion/LLFF.git
pip install scikit-image
python LLFF/imgs2poses.py ./colmap_tmp/

cp ./colmap_tmp/poses_bounds.npy ./data/multipleview/coffee_martini/poses_bounds_multipleview.npy
